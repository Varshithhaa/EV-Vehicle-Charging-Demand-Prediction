...
st.markdown("""
    <div style='text-align: center; font-size: 36px; font-weight: bold; color: white; margin-top: 20px;'>
...
# Welcome subtitle
st.markdown("""
    <div style='text-align: center; font-size: 22px; font-weight: bold;color:white; padding-top: 10px; margin-bottom: 25px;'>
...
# Instruction line
st.markdown("""
    <div style='text-align: left; font-size: 22px; padding-top: 10px; color: mediumseagreen;'>
